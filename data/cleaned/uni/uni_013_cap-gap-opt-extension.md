...
**Cap-Gap**until September 30th if you have your H-1B- I-797 receipt from USCIS
**or** - I-797 Approval Notice

- I-797 receipt from USCIS
...
“Cap-gap” work authorization is valid only through September 30th, even if you have an H-1B petition that remains pending on Oct. 1. If you continue to work without authorization, you risk accruing [unlawful presence](http://links.govdelivery.com/track?type=click&enid=ZWFzPTEmbWFpbGluZ2lkPTIwMTgwOTI4Ljk1NTQyNTYxJm1lc3NhZ2VpZD1NREItUFJELUJVTC0yMDE4MDkyOC45NTU0MjU2MSZkYXRhYmFzZWlkPTEwMDEmc2VyaWFsPTE3NTUwOTUzJmVtYWlsaWQ9Um1kMjIwMkBjb2x1bWJpYS5lZHUmdXNlcmlkPVJtZDIyMDJAY29sdW1iaWEuZWR1JmZsPSZleHRyYT1NdWx0aXZhcmlhdGVJZD0mJiY=&&&100&&&https://www.uscis.gov/legal-resources/unlawful-presence-and-bars-admissibility).
...
[Report your current employment](https://isso.columbia.edu/content/opt-reporting) if you haven’t yet done so.
...
- 1.
- I-797C Receipt Notice OR I-797A Approval Notice for a change of status to H-1B
*only.*


The documents below are*not*acceptable:- Selection in the H-1B electronic registration lottery or a Registration Selection Notice
...
- 2.
- Most recent
[I-94 arrival record](https://i94.cbp.dhs.gov/I94/#/recent-search)

- 3.
- OPT EAD

| 1. | I-797C Receipt Notice OR I-797A Approval Notice for a change of status to H-1B only.The documents below are not acceptable:
| |
| 2. | Most recent
|
...
[F-1 Students](https://compass.isso.columbia.edu/istart/controllers/client/ClientEngine.cfm?serviceid=EFormF1OPTCapGapI20RequestColumbia1520170ServiceProvider&menuFlag=true)**Not sure of your campus? **Check our [campus school list](https://isso.columbia.edu/content/schools-columbia-campuses).
...
According to [USCIS information on the Cap-Gap extension](https://www.uscis.gov/working-united-states/temporary-workers/h-1b-specialty-occupations-and-fashion-models/extension-post-completion-optional-practical-training-opt-and-f-1-status-eligible-students-under-h-1b-cap-gap-regulations), generally, you may travel abroad and return to the US in F-1 status during a Cap-Gap period if:
...
Please be sure to consult with your employer and/or attorney regarding [USCIS travel guidelines](https://www.uscis.gov/working-in-the-united-states/temporary-workers/h-1b-specialty-occupations-and-fashion-models/extension-of-post-completion-optional-practical-training-opt-and-f-1-status-for-eligible-students) as it relates to your H1B application.
...
You and your employer will need your passport, EAD card, I-797 receipt notice for H-1B Petition or I-797 B approval notice, Cap Gap I-20, passport. They can refer to page 21 of the [Employers’ I-9 Manual.](https://www.uscis.gov/sites/default/files/files/form/m-274.pdf)
...
See what USCIS says about the [Cap-Gap Extension.](https://www.uscis.gov/working-united-states/temporary-workers/h-1b-specialty-occupations-and-fashion-models/extension-post-completion-optional-practical-training-opt-and-f-1-status-eligible-students-under-h-1b-cap-gap-regulations)